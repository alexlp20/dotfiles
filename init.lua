...
vim.api.nvim_set_keymap('n', '<F11>', ':FloatermNew<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<F10>', ':FloatermToggle<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('t', '<F10>', '<C-\\><C-N>:FloatermToggle<CR>', { noremap = true, silent = true })

-- Enable telescope fzf native, if installed
pcall(require('telescope').load_extension, 'fzf')

-- See `:help telescope.builtin`
vim.keymap.set('n', '<F3>', require('telescope.builtin').find_files);
vim.keymap.set('n', '<F4>', require('telescope.builtin').live_grep);
